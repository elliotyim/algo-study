...
package arrayandstring.linkedlist2.step2;
...
//    return arr;
  ...
  //중첩 클래스
  //LinkedList에서 사용하는 클래스라면 굳이 패키지 멤버로 만들 필요가 없다.
  //LinkedList 안에 선언하여 중첩 클래스로 정의하는 것이 소스코드의 유지보수에 더 좋다.
  //외부에 직접 노출되지 않기 대문에 쓸데없는 클래스를 감추는 효과도 있다.(패키지가 깔끔해진다.)
  static class Node { 
    Object value; //저장할 값
